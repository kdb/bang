...
(function($) {
  ...
  function ddbasic_mobile_menu(open) {
    // Only toggle topbar links which is not used to control visibility
    // of the menu.
    if (open) {
      $('.topbar-menu .js-topbar-link:not(.default-override)').css("display", "block");
    }
    else {
      $('.topbar-menu .js-topbar-link:not(.default-override)').css("display", "none");
    }
  }
  ...
  $(document).ready(function () {
   ...
   // $('.front .js-topbar-search').css("display", "block");
    ...
    $('.js-topbar-link.topbar-link-user').on('click touchstart', function(e) {
      // Use the active class to determine whether the menu is toggled or not.
